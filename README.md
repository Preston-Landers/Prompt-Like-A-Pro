...
<div align="center">
  <figure style="display: inline-block; border: 2px solid #ddd; padding: 10px; margin: 20px 0;">
    ...
    <figcaption style="margin-top: 10px; font-style: italic;">
      A man in a turtleneck (?) riding a bicycle made of neural wheels
    </figcaption>
  </figure>
</div>
...
That's how so-called [chain-of-thought](#chain-of-thought) produce better
